...
which can be used to test pytca in compressed CSV format and Parquet and will place it in the test harness folder.
...
eg. /home/pytcauser/cuemacro/pytca/tests_harness_data
"""
...
from pytca.data.datatestcreator import DataTestCreator
from pytca.conf.constants import Constants
from pytca.analysis.tcarequest import MarketRequest
from pytca.analysis.tcamarkettradeloaderimpl import TCAMarketTradeLoaderImpl
...
def create_market_trade_data_eikon():
    ...
    which is dumped to the designated pytca test harness folder.
