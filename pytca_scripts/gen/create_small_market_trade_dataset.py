"""Dumps a small dataset of test market and trade data (fetched from Arctic) which can be used to test pytca in
...
eg. /home/pytcauser/cuemacro/pytca/test/resources
"""
