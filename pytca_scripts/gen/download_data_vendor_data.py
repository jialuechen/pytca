...
if __name__ == '__main__':
    ...
    if data_vendor == 'dukascopy':
        from pytca.data.databasesource import DatabaseSourceDukascopy as DatabaseSource
    elif data_vendor == 'ncfx':
        from pytca.data.databasesource import DatabaseSourceNCFX as DatabaseSource
