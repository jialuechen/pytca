...
if __name__ == '__main__':
    ...
    folder = '/home/pytcauser/debug_tick/'
    ...
    if database_dialect == 'arctic':
        from pytca.data.databasesource import DatabaseSourceArctic as DatabaseSource
    elif database_dialect == 'pystore':
        from pytca.data.databasesource import DatabaseSourcePyStore as DatabaseSource
    elif database_dialect == 'influxdb':
        from pytca.data.databasesource import DatabaseSourceInfluxDB as DatabaseSource
