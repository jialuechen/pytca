...
if [ $DISTRO == "ubuntu" ]; then
    ...
    # For Mongo 3.6
    sudo cp $pytca_CUEMACRO/batch_scripts/installation/mongodb-org-3.6.repo /etc/yum.repos.d/mongodb-org-3.6.repo

    # For Mongo 4.2
    # sudo cp $pytca_CUEMACRO/batch_scripts/installation/mongodb-org-4.2.repo /etc/yum.repos.d/mongodb-org-4.2.repo
...
# Make sure to edit mongo.conf to your pytca log folder location!