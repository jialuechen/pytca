...
# Installs pytca app on nginx web server, using gunicorn to run the Python app, generally much easier to use
...
site_name_nginx_conf="pytca_nginx_gunicorn.conf"
