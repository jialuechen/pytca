...
# All the major dependencies will be installed within Docker containers by pytca in a sandboxed environment

# Assumes Amazon username is pytcauser (can change to ec2-user, which is the default name too)
