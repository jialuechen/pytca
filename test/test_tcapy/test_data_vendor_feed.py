...
from pytca.data.databasepopulator import DatabasePopulatorNCFX, DatabasePopulatorDukascopy
from pytca.data.databasesource import DatabaseSourceNCFX, DatabaseSourceDukascopy
