...
from pytca.util.fxconv import FXConv

from pytca.analysis.tcaengine import TCAEngineImpl
from pytca.analysis.tcarequest import TCARequest, MarketRequest
from pytca.analysis.algos.benchmark import *
from pytca.analysis.algos.metric import MetricSlippage, MetricTransientMarketImpact
from pytca.analysis.algos.resultsform import *
from pytca.analysis.tradeorderfilter import *

from pytca.vis.tcaresults import TCAResults
from pytca.vis.report.tcareport import TCAReport
...
# So we are not specifically testing the database of pytca - can instead use CSV in the test harness folder
...
def get_sample_data(ticker_spec=None):
    ...
    tca_engine = TCAEngineImpl(version=pytca_version)
...
def test_market_data_convention(fill_market_trade_databases):
    ...
    market_loader =  Mediator.get_tca_market_trade_loader(version=pytca_version)
