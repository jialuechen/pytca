...
from pytca.analysis.tcaengine import TCARequest, TCAEngineImpl
...
# Test will only succeed if the test_pytca specific version is set
# assert constants.pytca_version == 'test_pytca'
...
def test_stress_tca(fill_market_trade_databases):
    """Makes several large TCARequests at the same time to stress test pytca application and also to check it works
