...
from pytca.analysis.tcarequest import TCARequest
from pytca.data.datafactory import MarketRequest, TradeRequest

from pytca.data.databasesource import DatabaseSourceCSVBinary as DatabaseSourceCSV
from pytca.data.databasesource import \
...
def test_write_chunked_market_data_arctic():
    """For very large CSV files we might need to read them in chunks. pytca supports this and also supports CSVs
...
def test_fetch_market_trade_data_csv():
    ...
    from pytca.data.datafactory import DataFactory
...
def test_fetch_market_trade_data_dataframe():
    ...
    for t in trade_order_list:
        ...
        from pytca.data.databasesource import DatabaseSourceDataFrame
