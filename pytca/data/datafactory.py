...
from pytca.analysis.tcarequest import TradeRequest, MarketRequest
...
class DataFactory(object):
    ...
    the DataFrame (or a user specified one) which we have fetched into an appropriate format for pytca.
