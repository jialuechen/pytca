...
from pytca.data.databasesource import AccessControl
...
from pytca.analysis.tcarequest import MarketRequest
...
class DatabasePopulatorNCFX(DatabasePopulator):
    ...
    def _get_input_data_source(self):
        from pytca.data.databasesource import DatabaseSourceNCFX
    ...
    def _fetch_market_data(self, start, finish, ticker, write_to_disk=True, read_cached_from_disk=True, web_proxies=constants.web_proxies):
        ...
        if df is None:
            # Convert pytca ticker into vendor ticker
...
class DatabasePopulatorDukascopy(DatabasePopulatorNCFX):
    ...
    def _get_input_data_source(self):
        from pytca.data.databasesource import DatabaseSourceDukascopy
...
class DatabasePopulatorEikon(DatabasePopulatorNCFX):
    ...
    def _get_input_data_source(self):
        from pytca.data.databasesource import DatabaseSourceEikon
