...
import pytca.vis.candlestick as figure_factory

from pytca.analysis.algos.metric import MetricWideBenchmarkMarkout
    ...
    def generate_table(self, data_frame):
        ...
        if constants.gui_table_type == 'html':
            ...
            # Quicker to render as an iFrame
                ...
                # df_html = r'<link rel="stylesheet" type="text/css" media="screen" href="pytca.css" />' + '\n'
