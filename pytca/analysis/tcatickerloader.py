...
from pytca.analysis.algos.metric import MetricExecutedPriceNotional
...
from pytca.analysis.tradeorderfilter import TradeOrderFilterTag
from pytca.analysis.dataframeholder import DataFrameHolder

from pytca.analysis.tcarequest import TCARequest, MarketRequest, TradeRequest

from pytca.data.databasesource import DatabaseSource
...
class TCATickerLoader(ABC):
    ...
    def __init__(self, version=constants.pytca_version, volatile_cache_engine=constants.volatile_cache_engine):
